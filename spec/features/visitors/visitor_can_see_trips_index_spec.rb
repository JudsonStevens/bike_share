...
describe 'Visitor' do
  context 'they visit a trips index page' do
    it 'should show the first 30 trips with all attributes' do
      ...
      trip = Trip.create(duration: 10, start_date: '2014-09-21T16:39:57-8:00', end_date: '2014-09-21T16:49:57-8:00', end_station_id: station_1.id, start_station_id: station_1.id, bike_id: 6, subscription_type: 'gold', zip_code: '78596')
