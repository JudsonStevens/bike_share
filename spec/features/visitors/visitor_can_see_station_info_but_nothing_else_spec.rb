...
describe 'Visitor' do
  context 'who is not logged in' do
    it 'can visit the station show page and see the information about that station' do
      user = User.create(first_name: 'Billy', last_name: 'Williams', address:'123 admin street', username:'admin', password: 'admin', role: 0)
      ...
      visit("/#{station1.name.parameterize}")
      ...
      expect(page).to_not have_link('Edit This Station')
      expect(page).to_not have_link('Delete This Station')
    end
  end
end