...
describe 'User' do
  context 'who is logged in' do
    it 'can see all relevant information on the trips dashboard' do
      ...
      trip2 = Trip.create(duration: 150, start_date: '2018-05-26 14:40:00' , end_date: '2018-05-30 14:48:01', bike_id: 3, subscription_type: 'Subscriber', end_station_id: station2.id, start_station_id: station1.id, zip_code:50000 )
      ...
      trip4 = Trip.create(duration: 110, start_date: '2018-05-23 14:40:00' , end_date: '2018-05-24 14:43:01', bike_id: 1, subscription_type: 'Subscriber', end_station_id: station4.id, start_station_id: station1.id, zip_code:50000 )
      ...
      trip6 = Trip.create(duration: 180, start_date: '2018-05-21 14:40:00' , end_date: '2018-05-24 14:47:01', bike_id: 3, subscription_type: 'Subscriber', end_station_id: station4.id, start_station_id: station2.id, zip_code:60000 )

      visit(trips_dashboard_path)

      # Average Trip Duration
      expect(page).to have_content(Trip.average(:duration))
      # Longest Trip
